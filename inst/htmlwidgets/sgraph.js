...
//},
        ...
        // 根据 label_grid_cell_size 动态计算字体大小
        let calculatedLabelSize = x.options.label_size;
        if (x.options.label_grid_cell_size) {
          // 线性插值计算字体大小：
          const baseSize = 9;
          const baseGrid = 100;
          const scaleFactor = 7; // 控制增长速度
          // 对数计算，使大值增长变缓，小值减小更平滑
